...
class ASICamera:
    ...
    def connect(self):
        ...
        try:
            ...
            asi_lib.ASISetControlValue(self.camera_id, ASI_EXPOSURE, camera_state['exposure'], 0)
            asi_lib.ASISetControlValue(self.camera_id, ASI_GAIN, camera_state['gain'], 0)
    ...
    def capture_snapshot(self):
        ...
        if result != ASI_SUCCESS:
            print(f"Failed to start exposure: {result}")
            return None
...
def update_settings():
    ...
    # TODO: Parse request and update exposure/gain
